...
fn physical_column_mapping_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    let columns = vec![
        Arc::new(Int32Array::from(vec![1, 2, 3])) as Arc<dyn Array>,
        Arc::new(StringArray::from(vec![Some("alice"), Some("bob"), None])) as Arc<dyn Array>,
    ];
...
fn reordered_nested_profile_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    ...
    Ok(RecordBatch::try_new(nested_profile_schema(), columns)?)
}

fn nested_timestamp_profile_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
...
fn nested_column_mapping_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    let profile = StructArray::from(vec![
        (
            Arc::new(
...
fn array_addresses_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    ...
    Ok(RecordBatch::try_new(array_addresses_schema(), columns)?)
}

fn array_column_mapping_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    let address_fields = vec![
...
fn map_attributes_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    ...
    Ok(RecordBatch::try_new(map_attributes_schema(), columns)?)
}

fn long_key_attributes_batch_with_int32_keys() -> Result<RecordBatch, Box<dyn std::error::Error>> {
...
fn map_column_mapping_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    ...
    Ok(RecordBatch::try_new(map_column_mapping_schema(), columns)?)
}

fn map_key_value_column_mapping_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
...
fn map_list_key_attributes_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
...
fn nested_map_key_attributes_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
...
fn reordered_physical_columns_batch() -> Result<RecordBatch, Box<dyn std::error::Error>> {
    let columns = vec![
        Arc::new(StringArray::from(vec![Some("alice"), Some("bob"), None])) as Arc<dyn Array>,
        Arc::new(Int32Array::from(vec![1, 2, 3])) as Arc<dyn Array>,
    ];
...
fn sequential_batch(rows: usize) -> Result<RecordBatch, Box<dyn std::error::Error>> {
